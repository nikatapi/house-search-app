...
1.Clone git repository: <tt>git clone https://github.com/nikatapi/house-search-app </tt>

2.Install all dependencies (use sudo for activeadmin) <tt>bundle install</tt>

3.Create the database <tt>rake db:schema:load</tt>

4.Now run your application <tt>rails s</tt> 
